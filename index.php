...
<body class="w-full min-h-screen flex justify-center items-center overflow-hidden poppins-regular">
  ...
  <header class="px-20 h-[100px] flex fixed top-0 w-full justify-between items-center">
    <a href="./" class="flex items-center"><img src="./assets/icons/<?= $flaticon ?>" class="w-12" alt="Quizzaps-Logo"> Made by Kelompok 4 😊</a>
    <button class="btn btn-primary"><a href="./admin/login.php" class="poppins-bold tracking-wide">Login</a></button>
  </header>
