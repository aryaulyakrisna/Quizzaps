...
<body class="flex justify-center items-center overflow-hidden px-8">
  <div class="w-[546px] fixed 2xl:bottom-[5%] bottom-0 right-[5%] max-lg:hidden"><img id="landing-page-img" src="./assets/icons/landing-page-img.svg" class=" w-full h-full lg:-translate-x-10 lg:translate-y-10 transition-all duration-500 delay-150"></div>
  <svg id="waves" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class=" fixed w-[120%] max-2xl:-bottom-[30%] max-lg:-bottom-[5%] -bottom-[25%] lg:translate-x-24 transition-all duration-500 delay-150"><path fill="#6A75F1" fill-opacity="1" d="M0,96L34.3,96C68.6,96,137,96,206,85.3C274.3,75,343,53,411,37.3C480,21,549,11,617,37.3C685.7,64,754,128,823,138.7C891.4,149,960,107,1029,85.3C1097.1,64,1166,64,1234,69.3C1302.9,75,1371,85,1406,90.7L1440,96L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path></svg>
