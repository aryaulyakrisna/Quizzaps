...
<body class="w-full  min-h-screen flex justify-center items-center overflow-hidden">
  ...
  <main class="max-w-md w-full text-center flex-col justify-center mb-4 px-8 py-20 bg-[#6A75F1]/10 backdrop-blur-sm shadow-xl rounded-3xl mx-4 max-lg:text-xs">
