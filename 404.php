...
<body class="w-full min-h-screen flex justify-center items-center overflow-hidden poppins-regular">
  ...
  <main class="max-w-xl text-center mx-4 scale-0 transition-all duration-500">
    ...
    <p class=" text-md poppins-regular mb-4">The page your looking for does not exist, If you think there's a problem, feel free to contact us. We're here to help <a href="https://github.com/aryaulyakrisna" class="link">github.com</a>.</p>
